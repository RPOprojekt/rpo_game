...
public class PlayerManeger : MonoBehaviour {
    ...
    public void ExitGame()
    {
        ...
        int bestTime = 21; // TRENUTNO JE TU ROCNO NASTAVLJEN CAS SAMO ZA TESTIRANJE... CE JE VEC KOT 20 JE 2. PUSKA ZAKLENJENA
        PlayerPrefs.SetInt("najboljsiCas", bestTime); //shrani najboljsi cas
